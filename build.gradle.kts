...
object Variables {
    // Note: On Linux, if you installed Starfarer into ~/something, you have to write /home/<user>/ instead of ~
...
tasks {
    ...
    // Note: This might only work with older Starsector releases
    ...
    register("create-metadata-files") {
        ...
        File(projectDir, "mod_info.json")
            .writeText(
                """
                    # THIS FILE IS GENERATED BY build.gradle.kts. (Note that Starfinder json permits comments)
                    {
                        "id": "${Variables.modId}",
